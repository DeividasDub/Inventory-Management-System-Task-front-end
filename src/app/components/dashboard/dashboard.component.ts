          ...
          <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
              <div class="hidden sm:flex sm:items-center sm:space-x-2">
                ...
                <span *ngFor="let role of user?.roles" class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded">
                  {{ role }}
                </span>
              </div>
              <button
              ...
              <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-8">
                  <div class="text-center">
                    ...
                    <p class="text-gray-600 mb-8">Manage your inventory efficiently with our comprehensive tools.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                      <div class="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">Manage your inventory</p>
                      </div>
                      ...
                      <div class="bg-green-50 p-6 rounded-lg">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Stock</h3>
                        <p class="text-gray-600 text-sm">Track movements</p>
                      </div>
                      
                      <div class="bg-purple-50 p-6 rounded-lg" *ngIf="isAdmin()">
                        ...
                        <p class="text-gray-600 text-sm">Manage partners</p>
                      </div>
                      ...
                      <div class="bg-orange-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 text-sm">Analytics & insights</p>
                      </div>
                    </div>
                      ...
                      <div class="space-y-3 text-left">
                        ...
                        <div class="flex justify-between items-center">
                          ...
                          <div class="flex space-x-1">
                            <span *ngFor="let role of user?.roles" class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">
                              {{ role }}
                            </span>
                          </div>
                        </div>
                        <div class="flex justify-between">
                          ...
                          <span class="text-gray-900">{{ isAdmin() ? 'Administrator' : 'Staff Member' }}</span>
                        </div>
                      </div>
                    </div>
