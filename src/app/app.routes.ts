...
export const routes: Routes = [
  ...
  { path: 'dashboard/suppliers', component: SuppliersComponent, canActivate: [adminGuard] },
  { path: 'dashboard/stock', component: StockMovementsComponent, canActivate: [authGuard] },
